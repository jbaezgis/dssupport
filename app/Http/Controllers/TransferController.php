...
class TransferController extends Controller
{
    ...
    public function storeOneWayManualBooking(Request $request)
    {
		$service = Service::findOrFail($request->service_id);
		...
		return redirect('bookings/edit/'.$booking->id.'?bookingkey='.$booking->bookingkey);
    }

    public function storeRoundTripManualBooking(Request $request)
    {
    ...
    public function manualUpdate(Request $request, $id)
    {
        ...
        $booking->arrival_date = Carbon::createFromFormat('d/m/Y', $request->arrival_date);
        $booking->arrival_time = date('H:i:s', strtotime($request->arrival_time));
